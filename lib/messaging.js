...
const MESSAGES = {
    hi: {
        ...
        rating: () => `Aapka consultation complete ho gaya hai. Kripya apni screen par diye gaye button ko daba kar apna anubhav batayein.`,
    ...
    ta: {
        ...
        rating: () => `Ungal consultation mudinthathu. Thayavu seithu thiraiyil ulla button-ai azhuthi ungal anubhavathai mathippida seiyavum.`,
    ...
    te: {
        ...
        rating: () => `Mee consultation purthi ayyindi. Dayachesi screen pai unna button nokki mee anubhavanni teliyajeyandi.`,
        paused: (clinic) => `${clinic} dwara queue aapabadindi. Dayachesi tarvata prayatninchandi.`
    },
    mr: {
        joined: (token, pos, clinic) => `Namaskar! ${clinic} madhe aaple swagat aahe. Aapala token number ${token} aahe. Ata ${pos} log pudhe aahet.`,
        ...
        now: (token) => `${token} number wale, aapli vel aali aahe! Doctor aapli vaat pahat aahet.`,
        done: (clinic) => `Consultation sampale. ${clinic} madhe alyabaddal dhanyavaad. Lavkar bara vha!`,
        rating: () => `Aaple consultation purna jhale aahe. Krupaya screen varil button dabun aple mat nondva.`,
    ...
    bn: {
        ...
        rating: () => `Apnar consultation sesh hoyeche. Onugroho kore screen e thaka button ti chipe apnar motamot janan.`,
    ...
    gu: {
        ...
        rating: () => `Aapnu consultation puru thayun che. Krupa karine screen par aapel button dabavine aapno anubhav janavo.`,
    ...
    kn: {
        ...
        rating: () => `Nimma consultation mugidide. Dayavittu screen nalli iruva button otti nimma anubhavavannu thilisi.`,
    ...
    ml: {
        ...
        rating: () => `Ningalude consultation kazhinju. Thayavayi screenile button amathi ningalude abhiprayam ariyikkuka.`,
    ...
    pa: {
        ...
        rating: () => `Aapda consultation poora ho gaya hai. Kripa karke screen te ditte button nu daba ke apna anubhav dasso.`,
