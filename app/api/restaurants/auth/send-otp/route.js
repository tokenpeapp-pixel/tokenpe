...
export async function POST(req) {
  try {
    ...
    // Verify restaurant exists with this email + phone
    ...
    if (error || !restaurant) {
      ...
      return Response.json({ success: false, message: 'No restaurant found with this email and phone number.' }, { status: 404 })
    }
      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#0f172a;border-radius:20px;overflow:hidden;border:1px solid rgba(124,58,237,0.3);">
        ...
        <tr>
          <td style="padding:36px 36px 28px;">
            ...
            <h1 style="margin:0 0 20px;font-size:26px;font-weight:900;color:#fff;line-height:1.2;">Hi, ${restaurant.name} 👋</h1>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center">
                  <a href="https://tokenpe.online/restaurant-login" style="display:inline-block;background:linear-gradient(135deg,#7c3aed,#5b21b6);color:#fff;padding:14px 32px;border-radius:12px;text-decoration:none;font-weight:700;font-size:15px;letter-spacing:0.3px;">
