...
/**
 * Extract interactive list reply from webhook payload (multiple shapes).
 */
export function extractInteractiveReply(body) {
    // Interakt sends the message as a JSON STRING inside body.data.message.message
    // e.g. `{"type":"list_reply","list_reply":{"id":"4","title":"..."}}`
