...
export async function POST(req) {
    try {
        ...
        // Verify it was issued for a school
        if (payload.vertical !== 'school') {
        ...
        if (updateError) {
            console.error('[School Reset PIN] Failed to update PIN:', updateError)
        ...
        console.error('[School Reset PIN Error]', err)
